        ...
        3020: function () {
          !(function (t) {
            ...
            function s(t, e, r) {
              var n = (r / 100) * (e - t);
              return (
                1 === (n = Math.round(t + n).toString(16)).length &&
                  (n = "0" + n),
                n
              );
            }
            function c(r, i) {
              ...
              var p,
                ...
                m,
                h,
                v = t("<div/>").addClass("jq-ry-group-wrapper").appendTo(r),
                y = t("<div/>")
              ...
              function F(t) {
                var e = (i.starWidth = t);
                return (
                  (f = window.parseFloat(i.starWidth.replace("px", ""))),
                  y.find("svg").attr({ width: i.starWidth, height: e }),
                  b.find("svg").attr({ width: i.starWidth, height: e }),
                  C(),
                  r
                );
              }
              function j(t) {
                return (
                  ...
                  y.find("svg:not(:first-child)").css({ "margin-left": t }),
                  b.find("svg:not(:first-child)").css({ "margin-left": t }),
                  C(),
                  r
                );
              }
              function q(t) {
                return (
                  (i.normalFill = t),
                  (i.rtl ? b : y).find("svg").attr({ fill: i.normalFill }),
                  r
                );
              }
              var z = i.ratedFill;
              function I(t) {
                ...
                return (
                  (i.ratedFill = t),
                  (i.rtl ? y : b).find("svg").attr({ fill: i.ratedFill }),
                  r
                );
              }
              function O(t) {
                (t = !!t), (i.rtl = t), q(i.normalFill), S();
              }
              function V(t) {
                (i.multiColor = t), I(t || z);
              }
              function M(n) {
                (i.numStars = n),
                ...
                for (var a = 0; a < i.numStars; a++)
                  y.append(t(i.starSvg || e)), b.append(t(i.starSvg || e));
                return F(i.starWidth), q(i.normalFill), j(i.spacing), S(), r;
              }
              function E(t) {
                return (
                  (i.maxValue = t),
              ...
              function W(t) {
                return (i.precision = t), R(i.rating), r;
              }
              function A(t) {
                return (i.halfStar = t), r;
              }
              function T(t) {
                return (i.fullStar = t), r;
              }
              function _(t) {
                var e,
                  r,
                ...
                return i.rtl && (f = c - f), parseFloat(f);
              }
              function P(t) {
                return (
                  (i.readOnly = t),
              ...
              function R(t) {
                ...
                return (
                  "string" == typeof e &&
                    ("%" === e[e.length - 1] &&
                      ((e = e.substr(0, e.length - 1)), E((n = 100))),
                    (e = parseFloat(e))),
                  (function (t, e, r) {
                    if (!(t >= e && t <= r))
                      throw Error(
                  ...
                  (i.rating = e),
                  S(),
                  k && r.trigger("rateyo.set", { rating: e }),
                  r
                );
              }
              function Y(t) {
              ...
              function L(t) {
                return (i.onChange = t), r;
              }
              function N(t) {
                var e = _(t).toFixed(i.precision),
                  n = i.maxValue;
                S((e = a(parseFloat(e), w, n))),
                  r.trigger("rateyo.change", { rating: e });
              }
              function Q() {
                var t, e;
                (e = !1),
                  ...
                  (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
                    ...
                    (e = !0),
                  e || (S(), r.trigger("rateyo.change", { rating: i.rating }));
              }
              function X(t) {
                var e = _(t).toFixed(i.precision);
                (e = parseFloat(e)), u.rating(e);
              }
              function $(t, e) {
                i.onInit &&
                  "function" == typeof i.onInit &&
                  i.onInit.apply(this, [e.rating, u]);
              }
              function D(t, e) {
                i.onChange &&
                  "function" == typeof i.onChange &&
                  i.onChange.apply(this, [e.rating, u]);
              }
              function G(t, e) {
                i.onSet &&
                  "function" == typeof i.onSet &&
                  i.onSet.apply(this, [e.rating, u]);
              }
              function H() {
                r.off("mousemove", N)
                  .off("mouseenter", N)
              ...
              (this.rating = function (t) {
                ...
                (k = !0),
                r.trigger("rateyo.init", { rating: i.rating });
            }
            function u(e, r) {
              var n;
              return (
                t.each(r, function () {
                  if (e === this.node) return (n = this), !1;
                }),
                n
              );
            }
