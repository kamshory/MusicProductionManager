...
class PicoMimeMap
{
     ...
     * @internal
     */
    public const EXTENSIONS_FOR_MIME_TYPES = array(
    ...
    {
        return isset(self::EXTENSIONS_FOR_MIME_TYPES[$mimetype][0]) ? self::EXTENSIONS_FOR_MIME_TYPES[$mimetype][0] : null;
    }
    ...
    {
        return isset(self::EXTENSIONS_FOR_MIME_TYPES[$mimetype]) ? self::EXTENSIONS_FOR_MIME_TYPES[$mimetype] : array();
    }
}
