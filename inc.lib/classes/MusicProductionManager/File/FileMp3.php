...
use MusicProductionManager\Exceptions\InvalidFileFormatException;
...
class FileMp3
{
     ...
     * @return void
     */
    public function setTag($mp3path, $tag)
    {
        $getID3 = new getID3;
    ...
    public function setImage($mp3path, $imageData, $mime = "image/jpeg", $description = "")
    {
        $getID3 = new getID3;
